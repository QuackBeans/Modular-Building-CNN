        ...
        for item_id, tags, public_urls in zipped_data:
            for url in public_urls:
                try:
                    ...
                    # Optionally save photos to drive
                    # parsed_url = urllib.parse.urlparse(url)
                    # filename = f'images/{item_id}_{os.path.basename(parsed_url.path)}'
...
# Fix bullshit timeout issue...(its always something...lol.) Also MA needs geckodriver added or whatever.
